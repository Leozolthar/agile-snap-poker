  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-[var(--transition-smooth)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-success text-primary-foreground hover:from-primary-hover hover:to-success-hover shadow-[var(--shadow-button)] hover:shadow-xl transform hover:scale-105 font-semibold",
        success: "bg-success text-success-foreground hover:bg-success-hover shadow-md hover:shadow-lg",
        poker: "bg-card text-card-foreground border-2 border-border hover:border-primary/50 hover:bg-primary/5 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)]",
      },
      size: {
